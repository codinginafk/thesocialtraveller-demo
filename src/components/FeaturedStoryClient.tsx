...
export default function FeaturedStoryClient({
  ...
  return (
    <>
      <div className="grid gap-6 overflow-hidden rounded-2xl lg:grid-cols-[1fr_1.2fr]">
        {/* Text panel */}
        ...
        {/* Video thumbnail — smaller, on the right */}
        <div
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <span className="flex h-14 w-14 items-center justify-center rounded-full border border-cream/60 bg-bark/40 backdrop-blur-sm transition-all group-hover:scale-110 group-hover:bg-clay">
              <svg width="16" height="18" viewBox="0 0 20 22" fill="none" className="ml-1 text-cream">
